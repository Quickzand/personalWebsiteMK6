function socialBarBuilder() {
    ...
    socialIcons.each(function () {
        $(this).css("animation-delay", startDelay + delayDifference * $(this).index() + "s");
    });
}
...
function metaTagsBuilder() {
    var author = $("<meta>").attr("name", "author").attr("content", "Matthew Sand");
    var description = $("<meta>").attr("name", "description").attr("content", "Fullstack Web Developer and Computer Science Student");
